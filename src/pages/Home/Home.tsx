...
import ImgAccountManagement from "../../assets/images/home/account-management.svg";
import ImgSavingEarningMoney from "../../assets/images/home/saving-earning-money.svg";
import ImgMarketingOverview from "../../assets/images/home/marketing-overview.svg";
      ...
      <div className="w-full h-full flex flex-col">
        ...
        <div className="flex flex-col padding-control bg-white pt-[50px] pb-[70px] md:pb-[8.5%] gap-5 md:!pr-0 md:flex-row">
          <div className="flex flex-col gap-5 w-full justify-center grow md:w-[47%]">
            ...
            <h4 className="font-poppins text-[#000000] text-md sm:text-lg sm:text-start text-center">
              Whether you&apos;re part of an enterprise, municipality,
              industrial operation, healthcare provider, or any sector within
              the commercial or energy industries, leave the heavy lifting to
              our network. We&apos;ll manage your energy service needs,
              delivering solutions that free up your resources so you can focus
              on your business&apos;s core operations and redirect additional
              revenue back into your business rather than toward high energy
              costs.
            </h4>
          </div>
        ...
        <div className="md:py-[128px] py-[50px] padding-control bg-white flex flex-col justify-center items-center">
          <div className="flex flex-col justify-center w-[100%] lg:w-[80%] xl:w-[60%] items-center gap-[20px] sm:mb-[60px] mb-[20px]">
            ...
            <p className="font-poppins text-[#4e6064] sm:text-md w-full text-center sm:leading-[30px] leading-[20px]">
              Our Energy Management Platform is designed for clients seeking
              savings and aiming to reduce high energy expenses. It provides an
              efficient, low-maintenance solution to optimize energy use, lower
              costs, and explore alternative options beyond simply paying
              monthly bill
            </p>
          </div>
          <div className="flex flex-row grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 xl:gap-10 gap-5">
            <div className="sm:py-[40px] sm:px-[24px] p-[24px] rounded-lg bg-white border border-[#1f7a5933] flex flex-col sm:gap-[30px] gap-[10px] sm:items-start items-center">
              ...
              <div className="text-[#4e6064] font-poppins text-base text-center sm:text-start">
                Avoid paying more than necessary for electricity with protection
                from the energy market, billing mistakes and the consistent rise
                in energy pricing.
              </div>
            </div>
            <div className="sm:py-[40px] sm:px-[24px] p-[24px] rounded-lg bg-white border border-[#1f7a5933] flex flex-col sm:gap-[30px] gap-[10px] sm:items-start items-center">
        ...
        <div className="sm:p-[30px] py-[30px] flex xl:flex-row flex-col xl:gap-0 gap-[30px] bg-[#0f352d] items-center">
          ...
          <div className="p-[20px] rounded-[24px] bg-white h-[223px] flex items-center flex-col z-1">
            ...
            <div
              className="text-base font-poppins py-[10px] bg-[#549F57] rounded-md w-[110px] mt-[24px] text-center cursor-pointer"
              onClick={goToAvailibility}
            >
              Next
            </div>
          </div>
