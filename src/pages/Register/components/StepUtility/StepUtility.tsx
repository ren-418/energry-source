...
const StepUtility: React.FC<StepUtilityProps> = ({ handleNextStep, handlePreviousStep, setCurrentStep }) => {
                    ...
                    <div className="flex flex-col gap-[12px]">
                        ...
                        {showUI &&
                            ...
                            utilities.map((utility, index) => (
                                index !== 0 &&
                                <UtilityCard key={utility.utility} utility={utility.utility} image={utility.image} handleNextStep={handleNextStep} />
                            ))
                        }
                    </div>
                </div>
