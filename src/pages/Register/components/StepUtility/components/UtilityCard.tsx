...
const UtilityCard: React.FC<UtilityCardProps> = ({ handleNextStep, setSelectedUtility, utility, logo }) => {
    return (
        <div
        ...
        >
            <div className="flex flex-row gap-[16px] items-center">
                ...
                <div className="h-[44px] flex justify-center items-center">
                    <img alt={utility} src={`${fileUrl}/${logo}`} className="w-[44px]" />
                </div>
                <div className="">
            ...
            <div className="">
                <svg className="ml-1 w-[18px] h-[18px]" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="EastIcon"><path d="m15 5-1.41 1.41L18.17 11H2v2h16.17l-4.59 4.59L15 19l7-7-7-7z"></path></svg>
            </div>
        </div>
    )
}
